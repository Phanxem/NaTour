...
public class RouteDAOImpl implements RouteDAO {
    ...
    @Override
    public RouteResponseDTO findRouteByCoordinates(String coordinates) throws IOException, ExecutionException, InterruptedException, ServerException {
        ...
        RouteResponseDTO result = JsonConverter.toRouteDTO(jsonObjectResult);
    ...
    @Override
    public RouteResponseDTO findRouteByGeoPoints(List<GeoPoint> geoPoints) throws IOException, ExecutionException, InterruptedException, ServerException {
